...
const Main = () => {
  return (
    <div className="bg-imgMainSec w-full h-[530px] bg-[#050827] bg-no-repeat bg-bottom bg-cover relative ">
      <div className="flex text-white flex-col items-center justify-center   absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 ">
        ...
        <h1 className="font-normal  text-[47px] leading-[60px]  mt-2 mb-3">
          Coffee Mugs
        </h1>
        <span className="font-normal text-[17px] leading-[30px] lg:w-[790px] md:w-[600px]  w-[350px]  mb-10 text-center">
